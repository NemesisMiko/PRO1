class Program
{
    ...
    public static void UstvariHišo()
    {
        ...
        kuhinja = new SobaZVrati("Kuhinja", "nerjaveči pripomočki", "navadna
       vrata");
       
        sprednjeDvorišče = new ZunanjiZVrati("Sprednje dvorišče", false, "hrastova
       vrata");
       
        zadnjeDvorišče = new ZunanjiZVrati("Zadnje dvorišče", true, "navadna
       vrata");
        ...
        dnevnaSoba.lokacija = sprednjeDvorišče;
        sprednjeDvorišče.lokacija = dnevnaSoba;
        kuhinja.lokacija = zadnjeDvorišče;
        zadnjeDvorišče.lokacija = kuhinja;
    }
